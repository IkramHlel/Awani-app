...
import 'package:awani_app/src/pages/navBarScreens/ShoppingScreens/payingPage.dart';
...
class _ShippingPageState extends State<ShippingPage> {
  ...
  Function _navigationPaying() {
    Navigator.of(context).push(
        MaterialPageRoute(builder: (BuildContext context) => PayingPage()));
  }
                ...
                child: Column(
                  children: [
                    Padding(
                        ...
                        child: _buildTextField('اسم العنوان')),
                    Padding(
                        padding: EdgeInsets.all(16),
                        child: _buildTextField('المنطقة')),
                    Padding(
                        padding: EdgeInsets.all(16),
                        child: _buildTextField('نوع السكن')),
                    Padding(
                        padding: EdgeInsets.all(16),
                        child: _buildTextField('البلوك')),
                    Padding(
                        padding: EdgeInsets.all(16),
                        child: _buildTextField('الجادة (اختياري)')),
                    Padding(
                      padding: EdgeInsets.all(16),
                      child: Row(
                        ...
                        children: [
                          Container(
                              width: 180, child: _buildTextField('رقم الشقة')),
                          Container(
                              width: 180, child: _buildTextField('الطابق')),
                        ],
                      ),
                    ),
                    Padding(
                        padding: EdgeInsets.all(16),
                        child: _buildTextField('ارشادات اضافية')),
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          Padding(
                            ...
                            child: AwaniText('حفظ العنوان', 16,
